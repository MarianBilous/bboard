$(function () {
    ...
    function theme1() {
        ...
        $('#settings_theme').val('bg-theme1');
    }

    function theme2() {
        $('body').attr('class', 'bg-theme bg-theme2');
        $('#settings_theme').val('bg-theme2');
    }

    function theme3() {
      $('body').attr('class', 'bg-theme bg-theme3');
      $('#settings_theme').val('bg-theme3');
    }

    function theme4() {
      $('body').attr('class', 'bg-theme bg-theme4');
      $('#settings_theme').val('bg-theme4');
    }

	function theme5() {
      $('body').attr('class', 'bg-theme bg-theme5');
      $('#settings_theme').val('bg-theme5');
    }

	function theme6() {
      $('body').attr('class', 'bg-theme bg-theme6');
      $('#settings_theme').val('bg-theme6');
    }

    function theme7() {
      $('body').attr('class', 'bg-theme bg-theme7');
      $('#settings_theme').val('bg-theme7');
    }

    function theme8() {
      $('body').attr('class', 'bg-theme bg-theme8');
      $('#settings_theme').val('bg-theme8');
    }

    function theme9() {
      $('body').attr('class', 'bg-theme bg-theme9');
      $('#settings_theme').val('bg-theme9');
    }

    function theme10() {
      $('body').attr('class', 'bg-theme bg-theme10');
      $('#settings_theme').val('bg-theme10');
    }

    function theme11() {
      $('body').attr('class', 'bg-theme bg-theme11');
      $('#settings_theme').val('bg-theme11');
    }

    function theme12() {
      $('body').attr('class', 'bg-theme bg-theme12');
      $('#settings_theme').val('bg-theme12');
    }
});
